 ...
 */
public class HoaDon {
   String id,idKH,idNV,ma,ngayTao,ngayThanhToan,ngayShip,ngayNhan;
   int tinhTrang;
   String tenNguoiNhan,diaChi,sdt;
    ...
    public HoaDon(String idKH, String idNV, String ma, String ngayTao, String ngayThanhToan, String ngayShip, String ngayNhan, int tinhTrang, String tenNguoiNhan, String diaChi, String sdt) {
        this.idKH = idKH;
        this.idNV = idNV;
        this.ma = ma;
        this.ngayTao = ngayTao;
