...
import Service.MS_impl;
import java.util.ArrayList;
import javax.swing.JOptionPane;
import javax.swing.table.DefaultTableModel;
import View_Model.*;
import Service.DAO_MS;
/**
 *
 * @author chung
 */
public class QLMS extends javax.swing.JFrame {
    ...
    public QLMS() {
        ...
        fillToTable(svr.getAllMauSac());
    }

    public void fillToTable(ArrayList<VMMauSac> lstvsp) {
        model = (DefaultTableModel) tblms.getModel();
        model.setRowCount(0);
        for (VMMauSac p : lstvsp) {
    ...
    public void showIndex() {
        VMMauSac p = svr.getAllMauSac().get(index);
        txtid.setText(p.getId());
        txtma.setText(p.getMa());
        txtname.setText(p.getTen());
        tblms.setRowSelectionInterval(index, index);
    }
    ...
    private void btnaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaddActionPerformed
        ...
        VMMauSac p = new VMMauSac( ma, ten);
        JOptionPane.showMessageDialog(this, svr.addNewMauSac(p));
        clear();
        fillToTable(svr.getAllMauSac());
    ...
    private void btnupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnupActionPerformed
        ...
        try {
            String ma = txtma.getText();
            String ten = txtname.getText();
            String id = svr.getAllMauSac().get(index).getId();
            VMMauSac p = new VMMauSac(ma, ten);
            JOptionPane.showMessageDialog(this, svr.UpdateMauSac(id, p));
            index = 0;
            clear();
            fillToTable(svr.getAllMauSac());
            tblms.setRowSelectionInterval(index, index);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "chon mau sac moun sua");
            return;
        }
    ...
    private void btnxoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnxoaActionPerformed
        ...
        try {
            String id = svr.getAllMauSac().get(index).getId();
            JOptionPane.showMessageDialog(this, svr.DeleteMauSac(id));
            index=0;
            clear();
            fillToTable(svr.getAllMauSac());
            tblms.setRowSelectionInterval(index, index);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "chon mau sac moun xoa");
            return;
        }
